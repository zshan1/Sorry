...
public class Canvas extends Pane {
    ...
    private void InitComponents() throws FileNotFoundException {
        ...
        root.setStyle("-fx-background-image: url('file:/Users/madis/workspace/SorryCurrent/src/board.png');"
...
//	 board1.addPeg(peg4, 4, 15);
        ...
        Image redpeg = new Image(new FileInputStream("C:\\Users\\madis\\workspace\\SorryCurrent\\src\\newred.png"));
        ...
        Image greenpeg = new Image(new FileInputStream("C:\\Users\\madis\\workspace\\SorryCurrent\\src\\newgreen.png"));
        ...
        Image bluepeg = new Image(new FileInputStream("C:\\Users\\madis\\workspace\\SorryCurrent\\src\\newblue.png"));
        ...
        Image yellowpeg = new Image(new FileInputStream("C:\\Users\\madis\\workspace\\SorryCurrent\\src\\newyellow.png"));
        ...
        draw.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                try {
                    String card = d.draw();
                    image = new Image(new FileInputStream("C:\\Users\\madis\\workspace\\SorryCurrent\\src\\card" + card + ".png"));
                ...
                alert.getButtonTypes().setAll(btnType1, btnType2, btnType3, btnType4, btnType5);
...
//					}
        ...
        menu.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                Image image;
                try {
                    image = new Image(new FileInputStream("C:\\Users\\madis\\workspace\\SorryCurrent\\src\\logo.png"));
                    Label label1 = new Label();
                    label1.setAlignment(Pos.CENTER);
                    label1.setGraphic(new ImageView(image));
                    alert.getDialogPane().setContent(label1);

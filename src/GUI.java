...
//
		...
		gameBoard.setBorder(new EmptyBorder(20, 20, 20, 20));
		gameBoard.setMinimumSize(new java.awt.Dimension(800, 600));
		gameBoard.setPreferredSize(new java.awt.Dimension(1000, 800));{
